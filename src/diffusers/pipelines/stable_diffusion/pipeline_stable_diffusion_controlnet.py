...
class StableDiffusionControlNetPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        hint: Optional[torch.FloatTensor] = None,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                control_output = self.controlnet(latent_model_input, t, encoder_hidden_states=prompt_embeds, hint=hint)
                control_samples = (*control_output.zero_conv_down_block_res_samples, control_output.zero_conv_sample)
